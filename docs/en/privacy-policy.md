...
The App does not include any analytics, crash reporting, or tracking SDKs. We do not actively collect device or usage telemetry.
...
Your data is stored securely using [Supabase](https://supabase.com/), which provides:
...
- **Data processor**: Your data is stored and processed by [Supabase](https://supabase.com/privacy), which uses AWS infrastructure. Supabase acts as a data processor on our behalf.
